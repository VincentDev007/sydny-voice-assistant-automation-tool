...
# ============================================================
# dev.sh — Single-Command SYDNY Startup Script
# ============================================================
...
#   3. Waits 2 seconds for the backend to initialize and load Whisper
...
#   - All pip packages installed (pip install -r docs/backend_requirements.txt)
...
#
# WHY sleep 2?
#   uvicorn needs a moment to start and load the Whisper model (~2-5 seconds).
...
# The backend needs to: start uvicorn → load FastAPI → load Whisper model
